...
public class TwitterBot {
	...
	// If the application fail, see the TwitterException
	public static void main(String... args) {
		...
		if (!debug) {
			try {
				...
				// Reply to a tweet
				//This example search for a twit that have the wrong sentence "your welcome" and replay that the rigth way to write ir is "you're"
